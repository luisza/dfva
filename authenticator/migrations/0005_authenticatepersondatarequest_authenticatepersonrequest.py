...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('authenticator', '0004_auto_20170731_0027'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='authenticator.AuthenticatePersonDataRequest')),
            ],
            options={
