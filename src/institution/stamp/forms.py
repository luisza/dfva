...
from institution.models import StampDataRequest
from django.utils.translation import ugettext_lazy as _


class StampDataForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['institution', 'request_datetime', 'document_hash']


class StampDataCheckForm(forms.ModelForm):
    notification_url = forms.CharField(max_length=200)
